			...
			<div class="col-sm-12 col-lg-12">
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						...
						<input type="hidden" name="sorece" value="${sorece.playerId }">
						...
						<c:when test="${trades eq null || empty trades}">
							...
							<c:forEach items="${trades }" var = "trade" varStatus="no">
								<c:forEach items="${trade.players }" var = "player" varStatus="num">
							...
							<tr>
								...
								<td class="text-center">${player.throwHand } ${player.throwHand } </td>
				...
				<div class="text-right">			
						...
						<!-- <button type="button" class="btn btn btn-warning" oNclick= "radio()">트래이드</button>-->
				</div>
				</form>
			</div>
		</div>
